...
-- додатково привів поле genre до нижнього регістру в індексі. Як на мене, такий варіант більш оптимальний для простих задач пошуку.
-- загалом, пошук по текстовим полям - це досить широка задача і її варто вирішувати згідно відповідних потреб
...
-- додавання рівно 6-ти записів в таблицю books
